...
// Placeholder — full implementation by Member 6
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-semibold text-slate-800 mb-2">Student Dashboard</h1>
        <p className="text-slate-500 text-sm mb-1">
          Welcome, <span className="text-slate-800 font-medium">{user?.name}</span>
        </p>
        <p className="text-slate-400 text-xs mb-8">
          Exam shell coming soon — implemented by the frontend team.
        </p>
        <button
          onClick={logout}
